        ...
        <div className="min-h-screen flex items-center justify-center bg-background">
            ...
            <div className="relative z-10">
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-white mb-2">Create an Organization</h1>
                    <p className="text-sm text-foreground/60 w-full max-w-sm mx-auto">
                        Get started with Aegis-Agent ID Control Plane
                    </p>
                </div>
                <SignUp appearance={{ elements: { formButtonPrimary: 'bg-indigo-500 hover:bg-indigo-600 text-white shadow-lg shadow-indigo-500/20' } }} />
            </div>
        </div>
    );
}
